...
public class ValidateInput {
    ...
    private static LocalTime[] course_start_times_monday = { LocalTime.parse("08:00", format), LocalTime.parse("09:00", format),
            LocalTime.parse("10:00", format), LocalTime.parse("11:00", format), LocalTime.parse("12:00", format), LocalTime.parse("13:00", format),
            LocalTime.parse("14:00", format), LocalTime.parse("15:00", format), LocalTime.parse("16:00", format), LocalTime.parse("17:00", format),LocalTime.parse("18:00", format),
            LocalTime.parse("19:00", format), LocalTime.parse("20:00", format), };

    private static LocalTime[] course_start_times_tuesday = { LocalTime.parse("08:00", format), LocalTime.parse("09:30", format),
    ...
    private static LocalTime[] lab_start_times_monday = { LocalTime.parse("08:00", format), LocalTime.parse("09:00", format),
            LocalTime.parse("10:00", format), LocalTime.parse("11:00", format), LocalTime.parse("12:00", format), LocalTime.parse("13:00", format),
    ...
    private static LocalTime[] lab_start_times_friday = { LocalTime.parse("08:00", format), LocalTime.parse("10:00", format),
